...
function calc2(){
	...
	//alert(age);
	//alert(reducere_vechime['<= 1 luna'][1]);
	console.log(reducere_vechime[0][1]);
	console.log(age + "  " + typeof(age));
	c = reducere_vechime[age - 1][1];
	e = 1;
...
function calc(){
	...
	for (var i = 0;i < 20;i++)
	{
		for (var j = 0;j < 2;j++)
		{
			console.log("I " + i + " J " + j + " MAT: " + reducere_vechime[i][j]);
		}
	}
	*/
	...
	//var tax=100;
		//return tax;
	console.log("EURO " + ($('#clasaEuro').val() - 1));
	if( $('#clasaEuro').val()-1 > 2  && $('#clasaEuro').val()-1 < 5){
		console.log("IF");
		return calc1();
